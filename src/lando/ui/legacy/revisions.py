...
class Revision(LandoView):
    ...
    def get(self, request, revision_id, *args, **kwargs):
        stack = legacy_api.stacks.get(revision_id)
        ...
        transplants = legacy_api.transplants.get_list(revision_id)
        ...
        if series and is_user_authenticated():
            ...
            dryrun = legacy_api.transplants.dry_run(data={"landing_path": landing_path})
