...
from lando.main.support import phab, is_user_authenticated
...
class Revision(LandoView):
    ...
    def get(self, request, revision_id, *args, **kwargs):
        ...
        transplants = legacy_api.transplants.get_list(f"D{revision_id}")
        ...
        if series and is_user_authenticated():
            ...
            dryrun = legacy_api.transplants.dryrun(data={"landing_path": landing_path})
